...
class phpbb_notification_type_topic extends phpbb_notification_type_base
{
	...
	*/
	public function get_email_template_variables()
	{
		...
		return array(
			...
			'U_TOPIC'					=> generate_board_url() . "/viewtopic.{$this->php_ext}?f={$this->notification_type_parent_id}&t={$this->notification_type_id}",
			'U_VIEW_TOPIC'				=> generate_board_url() . "/viewtopic.{$this->php_ext}?f={$this->notification_type_parent_id}&t={$this->notification_type_id}",
			'U_FORUM'					=> generate_board_url() . "/viewforum.{$this->php_ext}?f={$this->notification_type_parent_id}",
			'U_STOP_WATCHING_FORUM'		=> generate_board_url() . "/viewforum.{$this->php_ext}?uid={$this->user_id}&f={$this->notification_type_parent_id}&unwatch=forum",
		);
	}
	...
	*/
	...
	{
		return append_sid($this->phpbb_root_path . 'viewtopic.' . $this->php_ext, "f={$this->notification_type_parent_id}&amp;t={$this->notification_type_id}");
	}
